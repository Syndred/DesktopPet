...
以下 4 个模型已经下载并接入项目，全部来自 Poly Pizza，协议均为 `CC0 1.0`（可商用、可改编、无需署名）：

1. Shiba Inu  
   - 来源：`https://poly.pizza/m/y4wdQpg767`  
   - 本地文件：`apps/pc-app/runtime/assets/models/ShibaInu.glb`
2. Husky  
   - 来源：`https://poly.pizza/m/wcWiuEqwzq`  
   - 本地文件：`apps/pc-app/runtime/assets/models/Husky.glb`
3. Cat（A）  
   - 来源：`https://poly.pizza/m/qKICY6xla2`  
   - 本地文件：`apps/pc-app/runtime/assets/models/CatQuaterniusA.glb`
4. Cat（B）  
   - 来源：`https://poly.pizza/m/2f54vbV0In`  
   - 本地文件：`apps/pc-app/runtime/assets/models/CatQuaterniusB.glb`

模型来源清单文件：`apps/pc-app/runtime/assets/models/catalog.json`
